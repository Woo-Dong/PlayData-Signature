    ...
    ([entry]) => {
      ...
      if (entry.isIntersecting) {
        ...
        const counter = setInterval(() => {
          ...
          let n = currentString.length; 
          let innerString = ''; 

          if (n >= 4) { 
            
            innerString = currentString.slice(0, n-3).concat(','); 
            innerString = innerString.concat(currentString.slice(n-3, n));
          }
          else { 
            innerString = currentString;
          }
          // current.innerHTML = currentNumber;
          current.innerHTML = innerString;
